...
const handlerButton = {
  flexGrow: 1 // border: "1px inset black"
...
class Timer extends React.Component {
  ...
  switcher() {
    ...
    this.setState(prevState => {
      ...
      prevState.sessBreak == "SESSION" ? newTime = prevState.break : newTime = prevState.session; //some GUI indication:
  ...
  ticker(tickOrTock) {
    ...
    let nodeToPlay = document.getElementById("beep"); // nodeToPlay.load();
...
class Display extends React.Component {
  ...
  render() {
    ...
    }, this.props.timerLabel), React.createElement("br", null), React.createElement("div", null, "Time Left:"), React.createElement("div", {
      id: "time-left",
      style: timeStyle
...
class Beep extends React.Component {
  ...
  render() {
    return React.createElement("audio", {
      ...
      src: "http://66.90.93.122/ost/pokemon-gameboy-sound-collection/iniyxrzp/111-pokemon%20recovery.mp3",
      type: "audio/mp3"
    }));
  }
